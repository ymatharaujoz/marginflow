...
ALTER TABLE "external_order_items" ADD CONSTRAINT "external_order_items_external_product_fk" FOREIGN KEY ("external_product_id") REFERENCES "public"."external_products"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "external_orders" ADD CONSTRAINT "external_orders_marketplace_connection_fk" FOREIGN KEY ("marketplace_connection_id") REFERENCES "public"."marketplace_connections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "external_products" ADD CONSTRAINT "external_products_marketplace_connection_fk" FOREIGN KEY ("marketplace_connection_id") REFERENCES "public"."marketplace_connections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sync_runs" ADD CONSTRAINT "sync_runs_marketplace_connection_fk" FOREIGN KEY ("marketplace_connection_id") REFERENCES "public"."marketplace_connections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
