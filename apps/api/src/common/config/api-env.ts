...
const apiEnvSchema = z.object({
  ...
  STRIPE_PRICE_START_MONTHLY: z.string().min(1).optional(),
  STRIPE_PRICE_START_ANNUAL: z.string().min(1).optional(),
  ...
  STRIPE_PRICE_BUSINESS_ANNUAL: z.string().min(1).optional(),
